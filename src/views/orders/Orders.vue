...
const toggleMenu = () => fullMenu.value = !fullMenu.value
</script>
		...
		<div :style="{ 'min-width': fullMenu ? '' : '30%' }">
			...
			>
				<div class="d-flex align-items-center justify-content-between py-1">
					...
					<div v-if="!fullMenu" class="position-absolute end-0 h-100 d-flex alighn-items-center justify-content-center order-opened"><ChevronRightIcon style="width: 25px; color: white;"/></div>
				</div>
			</div>
		</div>
